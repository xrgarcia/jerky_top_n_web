...
- **Leaderboard**: Three-act storytelling structure celebrating achievement with always-visible empty states. "The Champions" (top 1-5) displayed in dramatic podium hero section with dark background; empty state shows 5 podium silhouettes with pioneer messaging and "Start Ranking" CTA. "Rising Contenders" (places 6-10) in list format with bigger/bolder styling than Community, showing competitive gap to podium; empty state displays 5 open slots with fire icons, competitive messaging, and "Start Your Climb" CTA. "The Community" (11+) in accessible list format; empty state shows 3 welcoming slots with community icons and "Join the Ranks" CTA. All empty states feature staggered fade-in animations and link to /rank. Dynamic rank calculation ensures sequential numbering regardless of dataset size.
...
- **Coin Book Page**: Elegant, typography-first three-act narrative page celebrating user achievement journey, designed to match the sophisticated aesthetic of the Community page. Hero section presents the Coin Book widget as the centerpiece with dark dramatic background and radial glow effect. Typography-driven hierarchy with uppercase titles, letter-spacing, and earth-tone color palette. Act labels ("ACT I", "ACT II", "ACT III") replace decorative emojis for professional storytelling. Act 1 "First Bite" (white, welcoming) introduces Flavor Coins and Engagement Coins using quarter-collection metaphor with subtle colored accent bars. Act 2 "Building Mastery" (warm light, achievement-focused) explains Static, Dynamic, and Hidden Collection Coins with visual tier progression (Bronze🥉 → Silver🥈 → Gold🥇 → Platinum🏆 → Diamond💎) - only functional emojis retained. Act 3 "The Masters" (dark, prestigious) spotlights five Dynamic Master Collections (Beef, Game, Pork, Poultry, Exotic) with category-specific accent colors on hover. Minimal decorative emoji use; visual hierarchy achieved through typography weight, spacing, and subtle color accents. CTAs link to /rank, /flavors, and /leaderboard.
