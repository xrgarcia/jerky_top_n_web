...
- **Coin Book Transition**: Storytelling intro text within Achievements section introducing the "Coin Book" concept with celebratory jerky.com voice. Staggered sequential reveal animation: heading (0.3s) → intro text (0.5s) → widget (0.7s).
