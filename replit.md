...
- **Coin Book Page**: Hero-centered three-act narrative page celebrating user achievement journey. Hero section presents the Coin Book widget as the centerpiece with dark dramatic background. Act 1 "First Bite" (white, welcoming) introduces Flavor Coins and Engagement Coins using quarter-collection metaphor, encouraging initial exploration. Act 2 "Building Mastery" (warm light, achievement-focused) explains Static, Dynamic, and Hidden Collection Coins with visual tier progression (Bronze → Silver → Gold → Platinum → Diamond). Act 3 "The Masters" (dark, prestigious) spotlights five Dynamic Master Collections (Beef, Game, Pork, Poultry, Exotic) as living challenges. Uses glossary terms naturally throughout storytelling, with CTAs linking to /rank, /flavors, and /leaderboard.
