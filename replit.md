...
## Recent Changes
- 2025-10-11: **Average ranking display on product cards** - Products now show their average ranking across all users with "Avg Rank: #X.X" badges; backend calculates AVG(ranking) from product_rankings table; displays on products page for products with at least one ranking; styled with green background badge for visual consistency with ranking counts
